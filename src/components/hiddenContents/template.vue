<template>
	<div id="hidden-contents">
		...
		<div class="overlay" v-on:click="closeHiddenContents">
			<i class="cuscon-close close"></i>
		</div>
	</div>
</template>

<script>
import hiddenContentsItem from '@/components/hiddenContents/item-parts.vue';
import hiddenContentsSnsItem from '@/components/hiddenContents/item-sns-parts.vue';
